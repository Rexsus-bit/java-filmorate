drop table FILM_GENRE_MATCHES, friendship_relations,  FRIENDSHIP_STATUS, GENRES,
...
ALTER TABLE friendship_relations ADD FOREIGN KEY (first_user_id) REFERENCES users (user_id);

ALTER TABLE friendship_relations ADD FOREIGN KEY (second_user_id) REFERENCES users (user_id);
