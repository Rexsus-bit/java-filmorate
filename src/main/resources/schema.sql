...
ALTER TABLE film_genre_matches ADD FOREIGN KEY (film_id) REFERENCES films (film_id) ON DELETE CASCADE;

ALTER TABLE film_genre_matches ADD FOREIGN KEY (genre_id) REFERENCES genres (genre_id);

ALTER TABLE friendship_relations ADD FOREIGN KEY (friendship_status_id) REFERENCES Friendship_status (friendship_status_id);

ALTER TABLE friendship_relations ADD FOREIGN KEY (first_user_id) REFERENCES users (user_id) ON DELETE CASCADE;

ALTER TABLE friendship_relations ADD FOREIGN KEY (second_user_id) REFERENCES users (user_id) ON DELETE CASCADE;
